...
function getTeamDayTmaSplitStats(items) {
  return {
    ...
    weekend: getWeightedTeamDayTmaStats(items, ({ item, resolvedType, dow }) => {
      const hasWork = getOsTmaMinutes(item) != null;
      if (!hasWork) return 0;
      if (dow === 6) {
    ...
    <div class="tma-help-panel">
      ...
      <div class="tma-help-body">
        ...
        <div class="tma-help-card">
          ...
          <div class="tma-help-card-note">No consolidado do mes: sabado de equipe normal vale meio dia. Domingo com atendimento entra no calculo. Quando voce detalha um unico dia, o calculo divide pelas equipes ativas naquele dia, sem dobrar o sabado.</div>
        </div>
        <div class="tma-help-card">
