...
function showDayDetails(day, cidade, techKey) {
  ...
  const weekdayTeamDayAvgStr = teamDayTmaSplitStats.weekday.bucketCount ? formatMinutesCompact(teamDayTmaSplitStats.weekday.monthlyMinutesPerTeamDay) : '--';
  const weekendTeamDayAvgStr = teamDayTmaSplitStats.weekend.bucketCount ? formatMinutesCompact(teamDayTmaSplitStats.weekend.monthlyMinutesPerTeamDay) : '--';
  let subtitle = `Regional: ${escapeHtml(cidade || 'Todas')}`;
        ...
        <div class="tma-modal-summary">
          ...
          <div class="tma-highlight-grid">
            ...
            <div class="tma-highlight-card is-cyan">
              <div class="tma-highlight-label">Media por equipe em dia util</div>
              <div class="tma-highlight-value">${weekdayTeamDayAvgStr}</div>
              <div class="tma-highlight-meta">${formatMinutesCompact(teamDayTmaSplitStats.weekday.totalMinutes)} divididos por ${teamDayTmaSplitStats.weekday.equivalentBucketCount || 0} dias-equipe uteis</div>
            </div>
            <div class="tma-highlight-card is-green">
              ...
              <div class="tma-highlight-meta">${formatMinutesCompact(teamDayTmaSplitStats.weekend.totalMinutes)} divididos por ${teamDayTmaSplitStats.weekend.equivalentBucketCount || 0} dias-equipe no fim de semana · sabado normal vale meio dia</div>
            </div>
    ...
    <div class="tma-help-panel">
      ...
      <div class="tma-help-body">
        ...
        <div class="tma-help-card">
          ...
          <div class="tma-help-card-note">Sabado de equipe normal vale meio dia. Plantao 12/36 vale um dia inteiro no sabado e no domingo.</div>
        </div>
        <div class="tma-help-card">
